...
def draw_player_stats(output_video_frames,player_stats):
    ...
    for index, row in player_stats.iterrows():
        ...
        text =" Developed by Eng. Firas Tlili"
        output_video_frames[index] = cv2.putText(output_video_frames[index], text, (start_x+10, start_y+300), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (255, 255, 255), 1)
